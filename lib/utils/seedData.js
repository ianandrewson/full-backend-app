...
const seedData = async() => {
      ...
      password: 'password'
        ...
        const user1Budget1 = await Budget.create({
          ...
          budget: 1000
            ...
            //for expenditure aggregation: most expensive item of the month
        ...
        const user1Budget2 = await Budget.create({
          ...
          budget: 1000
            ...
            //for expenditure aggregation: total item costs for the month
            await Expenditure.create({
    ...
    const user2 = await User.create({
      ...
      password: 'password'
        ...
        //for expenditure aggregation: total expenditures for the month
